...
namespace Ticketing.GraphQL.Web.Migrations
{
    ...
    [Migration("20240309205106_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ticketing.GraphQL.Web.DomainObjects.KundeUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Ticketing.GraphQL.Web.DomainObjects.PurchasedTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Ticketing.GraphQL.Web.DomainObjects.VeranstalterUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Ticketing.GraphQL.Web.DomainObjects.Veranstaltung", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Ticketing.GraphQL.Web.DomainObjects.PurchasedTicket", b =>
                {
                    b.HasOne("Ticketing.GraphQL.Web.DomainObjects.KundeUser", "KundeUser")
                        .WithMany("PurchasedTickets")
                        .HasForeignKey("KundeUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ticketing.GraphQL.Web.DomainObjects.Veranstaltung", "Veranstaltung")
                        .WithMany("PurchasedTickets")
                        .HasForeignKey("VeranstaltungId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("KundeUser");
            ...
            modelBuilder.Entity("Ticketing.GraphQL.Web.DomainObjects.Veranstaltung", b =>
                {
                    b.HasOne("Ticketing.GraphQL.Web.DomainObjects.VeranstalterUser", null)
